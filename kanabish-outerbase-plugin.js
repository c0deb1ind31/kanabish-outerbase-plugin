  ...
  class OuterbasePluginTableConfiguration_$PLUGIN_ID extends HTMLElement {
    ...
    render() {
      ...
      this.shadow.querySelector("#configuration-container").innerHTML =
        `
          <div style="flex: 1;">
              <p class="field-title">Task Name Key</p>
        ...
        `
              ...
              <p class="field-title">Task Description Key</p>
        ...
        `
              ...
              <p class="field-title">Task Assigned to name Key </p>
        ...
        `
                ...
                <p class="field-title">Task Document Link Key </p>
        ...
        `
              ...
              <p class="field-title">Task Due Date key </p>
        ...
        `
              ...
              <p class="field-title"> Task priority key </p>
        ...
        `
          ...
          <p class="field-title">Task Project Tag key </p>
        ...
        <p class="field-title">Task Status  key </p>
      ...
      var saveButton = this.shadow.querySelector("#saveButton");
